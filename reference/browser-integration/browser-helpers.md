...
Set up and maintain browser verification infrastructure using `agent-browser` CLI and Chrome DevTools Protocol (CDP). This replaces the old Playwright-based helper library with a simpler, environment-agnostic approach.
